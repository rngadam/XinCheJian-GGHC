...
public class MainActivity extends Activity implements InformationSource {
	...
	public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(new GraphicsView(this, this));
	    ...
	    private static class GraphicsView extends View {
	        ...
	        private void drawMouth(Canvas canvas, int x, int y) {
				canvas.drawRect(x-2f*unit, y-unit, x+2f*unit, y+unit, lips);
				canvas.drawRect(x-1.75f*unit, y-0.75f*unit, x+1.75f*unit, y+0.75f*unit, teeths);
			}
